      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-blue-200">Phi Beta Sigma Fraternity, Incorporated</span>
              </div>
            </div>
            <p className="text-blue-200 mb-2">
              Fort Myers, Florida
            </p>
            <p className="text-blue-200 max-w-md mb-4">
              Serving Southwest Florida with Brotherhood, Scholarship, Leadership, and Service.
            </p>
            <p className="text-blue-100 font-semibold italic mb-6">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/support" className="text-blue-200 hover:text-white transition-colors">Partner With Us</Link></li>
              <li><Link to="/support" className="text-blue-200 hover:text-white transition-colors">Sponsorship</Link></li>
        ...
        <div className="border-t border-blue-800 mt-12 pt-8 text-center text-blue-200 text-sm">
          ...
          <p className="mt-1 text-blue-100 italic">"Culture for Service and Service for Humanity"</p>
        </div>
      </div>
    </footer>
  );
